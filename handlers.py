...
def main_keyboard(lang: str, tg_id: int = 0) -> ReplyKeyboardMarkup:
    ...
    if tg_id:
        return ReplyKeyboardMarkup([
            ...
            [KeyboardButton(T(lang, "btn_rooms_nearby"),  web_app=wb("/rooms?nearby=1")),
             KeyboardButton(T(lang, "btn_stores_nearby"), web_app=wb("/stores?nearby=1"))],
    ...
    return ReplyKeyboardMarkup([
        ...
        [KeyboardButton(T(lang, "btn_rooms_nearby")), KeyboardButton(T(lang, "btn_stores_nearby"))],
